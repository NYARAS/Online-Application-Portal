 ...
 @endif
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{url('/addexperience') }}">
                        {{ csrf_field() }}
...
<label for="years" class=" col-md-4 control-label">Total Full Time Experience: Years</label>
                            <div class="col-md-2 ">
                                ...
                                <input id="years" type="text" class="form-control" name="years" value="{{ old('years') }}" required autofocus>
                            ...
                            <div class="col-md-4">
                              <label for="first_institution" class=" control-label">1: Institution Name</label>
                                <input id="first_institution" type="text" class="form-control" name="first_institution" value="{{ old('first_institution') }}" required autofocus>

                                @if ($errors->has('first_institution'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('first_institution') }}</strong>
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="col-md-2">
                             ...
                             <div class="col-md-4">
                              <label for="second_institution" class=" control-label">2: Institution Name</label>
                                <input id="second_institution" type="text" class="form-control" name="second_institution" value="{{ old('second_institution') }}" required autofocus>

                                @if ($errors->has('second_institution'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('second_institution') }}</strong>
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="col-md-2">
                             ...
                             <div class="col-md-4">
                              <label for="third_institution" class=" control-label">3: Institution Name</label>
                                <input id="third_institution" type="text" class="form-control" name="third_institution" value="{{ old('third_institution') }}" required autofocus>

                                @if ($errors->has('third_institution'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('third_institution') }}</strong>
                                    </span>
                                @endif
                            </div>
