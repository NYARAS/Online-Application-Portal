...
<div class=" form-group required col-sm-12">
  ...
  <input type="text" name="name_of_institution" id="name_of_institution" class="form-control" required autofocus></input>
...
<div class=" form-group required col-sm-12">
  ...
  <input type="text" name="end_date" id="end_date" class="form-control" placeholder="dd/mm/yyyy" required autofocus></input>
