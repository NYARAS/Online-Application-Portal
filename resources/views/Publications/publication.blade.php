...
<form  method="POST"  action="#" enctype="multipart/form-data" id="frm-create-student">
{!!csrf_field()!!}
...
<div class="row">
	...
	<input type="text" name="number_of_books" id="number_of_books" class="form-control" ></input>
		</div>
		</div>
		...
		{{--------Copy of Books------------}}
			...
			<input type="file" name="list_of_books" id="list_of_books" class="form-control"  ></input>
...
<input type="text" name="referee_three" id="referee_three"  value="{{ ($publication->referee_three) }}" class="form-control"></input>
...
<div class="panel-footer">
  <a href='{{url("/publications/applicant/edit-publications/{$publication->applicant_id}")}}' class="btn btn-success btn-xs">
...
<div class="panel panel-body" style="padding-bottom: 10px; margin-top: 0;">
<form  method="POST"  action="{{route('storepublication') }}" enctype="multipart/form-data" id="frm-create-student">
{!!csrf_field()!!}
<div class="row">
<div class="col-lg-12">
...
<div class="row">
	...
	<input type="text" name="number_of_journals" id="number_of_journals" class="form-control"  ></input>
	...
	{{--------Number of Journals Copy------------}}
  	...
  	<input type="file" name="list_of_journals" id="list_of_journals" class="form-control" ></input>
  		</div>
  		</div>
...
<div class="form-group required">
<label for="country" class="control-label">1. Full Name of First Referee</label>
<input type="text" name="referee_one" id="referee_one" class="form-control" required autofocus></input>
...
<div class="form-group required" >
<label for="district" class="control-label">2:Full Name of Second Referee</label>
<input type="text" name="referee_two" id="referee_two" class="form-control" required autofocus></input>
...
<div class="form-group required">
<label for="referee_three" class="control-label">2:Full Name of Third Referee</label>
<input type="text" name="referee_three" id="referee_three" class="form-control" required autofocus></input>
