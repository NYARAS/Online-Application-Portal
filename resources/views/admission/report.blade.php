...
<tr>
	...
	<td colspan="0" style="text-align: right; padding-left: 80px;">
			<img src="#" class="imageAeu"/>

				</td>
					<h5 style="text-align:center">Department Of Computing and Information Sciences (Master Degree Application)</h5>
...
<u style="font-family:Poppins">Serial Number: <b>{{sprintf("%05d", $q->serial_number)}}</b></u>
	</td>


</tr>
<tr>
		<td><h3><u>Applicant Personal Information</h3></u></td>
</tr>
<tr>
...
<tr>
		<td style="width: 12px;">
		Course Applied: <b>{{$q->course_name}}</b>
	</td>
</tr>
</table>
...
<tr>
	...
	<td style="width: 200px; padding: 5px 0px;">
	Secondary School Attended: <b>	{{$q->secondary}}</b>


	</td>
  <td style="width: 200px; padding: 5px 0px;">

  University Attended: <b>	{{$q->university}}</b>


	</td>
  <td style="width: 200px; padding: 5px 0px;">

  Any Other Qualification: <b>	{{$q->other_qualifications}}</b>
...
<tr>
	...
	<td style="width: 200px; padding: 5px 0px;">
	{{$q->date_of_completion}}: <b>	{{$q->date_of_completion}}</b>

	</td>
	<td style="width: 200px; padding: 5px 0px;">
	Year: <b>	{{$q->date_of_completion}}</b>
