...
<p style="font-size:30px; color:Blue;font-family: 'Spicy Rice', cursive;">Add New Course</p>
...
@endif
    <div class="row">
      <form method="POST" action="{{url('/course') }}" enctype="multipart/form-data"  id="frm-create-student" class="col s12">
      {!!csrf_field()!!}
      ...
      <div class="input-field col-md-6 ">
          <label for="icon_prefix" class="active control-label " >Course Name</label>
        <i class="material-icons prefix"></i>
        <input   id="icon_prefix" class="form-control"  name="course_name" type="text" class="validate" required autofocus >
...
<div class="row">
      ...
      <div class="input-field col-md-12">
          <label for="icon_prefix" class="active  control-label " >Requirements/description</label>
        <i class="material-icons prefix"></i>
        <textarea class="form-control" id="article-ckeditor"   rows="10" name="course_body" id="course_body" required autofocus>
